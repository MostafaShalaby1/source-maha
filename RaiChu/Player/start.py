...
from RaiChu.config import BOT_USERNAME, ASSISTANT_USERNAME, OWNER_NAME
...
async def start(_, message: Message):
        ...
        f"""**مرحبا بك فـ سـوُرس مـهـأأ يتيح لك تشغيل الموسيقي والفيديو بدون اي مشكله وبدون تهنيج 🤍😊
            ...
            [
                [
                    InlineKeyboardButton(
                        "مـطـوُر ألـبـوُت..♡", url=f"https://t.me/{OWNER_NAME}"),
                ]
                [
                    InlineKeyboardButton(
